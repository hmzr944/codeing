...
var SHELL = [
  ...
  './js/signs.js', './js/illustrations.js', './js/diagrams.js', './js/search.js', './js/ia.js', './js/sessions.js', './js/store.js', './js/sound.js', './js/srs.js',
  './js/vendor/gsap.min.js', './js/ui.js', './js/motion.js',
